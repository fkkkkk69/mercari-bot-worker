...
async function handleCommand(env, chatId, text, fromUsername) {
  ...
  if (cmd === "/start") {
    ...
    await tgApi(env, "sendMessage", {
      ...
      text:
        "Привет! Команды:\n\n" +
        "добавить бренд <название> — добавить бренд в отслеживание\n" +
        "убрать бренд <название> — убрать бренд\n" +
        "добавить цену <бренд> <мин> <макс> — задать цену конкретному бренду\n" +
        "убрать цену <бренд> — убрать индивидуальную цену бренда\n" +
        "добавить цену всем <мин> <макс> — задать общую цену для брендов без своей цены\n" +
        "убрать цену всем — убрать общую цену\n" +
        "статус — твои текущие настройки\n" +
        "все бренды — список всех доступных брендов\n" +
        "очистить — полностью сбросить все настройки\n" +
        "стоп — отписаться\n" +
        "старт — включить подписку снова\n\n" +
        SUPPORT_LINE,
    });
    return;
  }
